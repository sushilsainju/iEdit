...
- (void)show
{
    ...
    [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionCurveEaseInOut
					 animations:^{
						 self.backgroundColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:0.8f];
...
- (UIView *)createContainerView
{
    ...
    [self setFrame:CGRectMake(30, 0, screenSize.width, screenSize.height)];
...
//    dialogContainer.layer.borderColor = [[UIColor colorWithRed:255/255.0 green:146.0/255.0 blue:146.0/255.0 alpha:1.0f] CGColor];
//    dialogContainer.layer.borderWidth = 1;
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, dialogContainer.bounds.size.height - buttonHeight-10 - buttonSpacerHeight, dialogContainer.bounds.size.width, buttonSpacerHeight)];
...
//    CGFloat buttonWidth = container.bounds.size.width / [buttonTitles count];
    ...
    for (int i=0; i<[buttonTitles count]; i++)
    {
        ...
        [closeButton setFrame:CGRectMake(20+1.5*i * buttonWidth, container.bounds.size.height-4 - buttonHeight, buttonWidth, buttonHeight)];
...
//        lineView.backgroundColor = [UIColor colorWithRed:198.0/255.0 green:198.0/255.0 blue:198.0/255.0 alpha:1.0f];
        ...
        [closeButton setBackgroundColor:[UIColor colorWithRed:57.0/255.0 green:57.0/255.0 blue:57.0 /255.0 alpha:1.0f]];
